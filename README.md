...
In PEEB2 - my other repository - we calculated an anthropogenic CO2 annual interest rate of 0.82% given a 2015 carbon footprint of 4 tons per person:
We also calculated theCO2 weight gain between 1750 (280 ppmv) and 2015 (400 ppmv) of 1.07 x 1012 tons, which, even on a crash diet of zero CO2 emissions from all sources and zero population growth, would take between 74 and 294 years to lose, assuming nature’s absorption capacity to be between 2 tons and ½ ton, respectively.
